        ...
        <div class="col-12">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <form method="POST" action="<?= BASE_URL ?>pc/createMaterial">
                        <div class="row">
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control" id="mat_id" name="mat_id" 
                                           value="<?= htmlspecialchars(isset($data['mat_id']) ? $data['mat_id'] : '') ?>" 
                                           placeholder="เช่น MAT001" required maxlength="30">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control" id="name" name="name" 
                                           value="<?= htmlspecialchars(isset($data['name']) ? $data['name'] : '') ?>" 
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control" id="LR" name="LR" 
                                           value="<?= htmlspecialchars(isset($data['LR']) ? $data['LR'] : '') ?>" 
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="number" class="form-control" id="unit" name="unit" 
                                           value="<?= htmlspecialchars(isset($data['unit']) ? $data['unit'] : '0.00') ?>" 
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input type="number" class="form-control" id="min" name="min" 
                                           value="<?= htmlspecialchars(isset($data['min']) ? $data['min'] : '0') ?>" 
                                           min="0" required>
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="number" class="form-control" id="upk" name="upk" 
                                           value="<?= htmlspecialchars(isset($data['upk']) ? $data['upk'] : '0.00') ?>" 
                                           step="0.01" min="0" required>
                                </div>
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control" id="image" name="image" 
                                           value="<?= htmlspecialchars(isset($data['image']) ? $data['image'] : '') ?>" 
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control" id="supplier" name="supplier" 
                                           value="<?= htmlspecialchars(isset($data['supplier']) ? $data['supplier'] : '') ?>" 
...
document.getElementById('name').addEventListener('input', function() {
    ...
    const materialIdInput = document.getElementById('mat_id');
    
    if (materialName && !materialIdInput.value) {
        // สร้างรหัสวัสดุจากชื่อ
        const code = 'MAT' + Date.now().toString().slice(-6);
        materialIdInput.value = code;
    }
});
